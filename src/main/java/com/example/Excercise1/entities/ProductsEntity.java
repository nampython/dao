...
public class ProductsEntity implements ValueObject {
    ...
    public String getSelectSql() {
        return Database.generatedSqlQuery().get("products").get(1);
    }

    @Override
    public String getDeleteSql() {
        return Database.generatedSqlQuery().get("products").get(2);
    }

    @Override
    public String getUpdateSql() {
        return Database.generatedSqlQuery().get("products").get(3);
    }

    @Override
    public String getInsertSql() {
        return Database.generatedSqlQuery().get("products").get(4);
    }
}
